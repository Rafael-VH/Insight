...
import 'package:insight/features/stats/domain/entities/text_block.dart' as entities;
import 'package:insight/features/stats/domain/entities/text_line.dart' as entities;
...
class OcrResultModel extends OcrResult {
  ...
  factory OcrResultModel.fromRecognizedText(RecognizedText recognizedText, String imagePath) {
    final textBlocks = recognizedText.blocks.map((block) {
      return entities.TextBlock(
        text: block.text,
        boundingBox: block.boundingBox,
        lines: block.lines.map((line) {
          return entities.TextLine(text: line.text, boundingBox: line.boundingBox);
        }).toList(),
      );
    }).toList();
